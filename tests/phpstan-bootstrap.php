...
defined( 'HELLO_LOGIN_ENABLE_LOGGING' ) || define( 'HELLO_LOGIN_ENABLE_LOGGING', 0 );
defined( 'HELLO_LOGIN_LOG_LIMIT' ) || define( 'HELLO_LOGIN_LOG_LIMIT', 0 );
defined( 'HELLO_LOGIN_PROVIDER_HINT' ) || define( 'HELLO_LOGIN_PROVIDER_HINT', '' );
defined( 'HELLO_LOGIN_MEMBERPRESS_ENABLE_LOGIN' ) || define( 'HELLO_LOGIN_MEMBERPRESS_ENABLE_LOGIN', 0 );
defined( 'HELLO_LOGIN_MEMBERPRESS_ENABLE_REGISTRATION' ) || define( 'HELLO_LOGIN_MEMBERPRESS_ENABLE_REGISTRATION', 0 );
defined( 'HELLO_LOGIN_MEMBERPRESS_ENABLE_ACCOUNT' ) || define( 'HELLO_LOGIN_MEMBERPRESS_ENABLE_ACCOUNT', 0 );
